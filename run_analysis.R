# This code will Use data collected from the accelerometers from the Samsung Galaxy S 
# smartphone to make a clean data set named "tidy_data.txt".
...
## (Step5) Create a second, independent tidy set with the average of each Variable for each activity and each subject
